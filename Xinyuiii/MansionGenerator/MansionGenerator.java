...
public class MansionGenerator {
    public boolean generate(long worldSeed, int chunkX, int chunkZ, ChunkRand rand, MCVersion version, OverworldTerrainGenerator otg) {
        ...
        int k = (chunkX << 4) + 7;
        int l = (chunkZ << 4) + 7;
        int i1 = otg.getHeightInGround(k,j);
